...
/**
 * Sucessão — Similar ao 9Box
 * Figma: 5683:154746 (1440x2455)
 */
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
      ...
      <DataTable
        ...
        columns={[
          ...
          },
          {
            ...
            render: (_, row) => <Badge variant={row.classColor as 'blue'}>{String(row.classification)}</Badge>,
          },
          {
      ...
      <div style={{
        ...
        <div>
          <p style={{ fontSize: '18px', fontWeight: 500, color: '#363F72', margin: 0 }}>Todas as atividades</p>
